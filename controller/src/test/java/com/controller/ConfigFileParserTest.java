...
public class ConfigFileParserTest {
    ...
    public void createMockJSON() {
        ...
        try {
            PrintWriter mockJSON = new PrintWriter("./mock_config.json","UTF-8");
    ...
    public void testMockJSON() {
        HashMap<String, String> mockRes = ConfigFileParser.getInputFromConfigFile("./mock_config.json");
    ...
    public void deleteMockJSON() {
        File file = new File("./mock_config.json");
        file.delete();
    }
}